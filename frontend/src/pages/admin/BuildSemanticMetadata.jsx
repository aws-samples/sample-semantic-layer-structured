        ...
        <SpaceBetween size="l">
          {buildStatus === "idle" && (
            <Box>
              <SpaceBetween size="m">
                <Box variant="p">
                  Ready to build semantic metadata. The AgentCore metadata agent
                  will:
                </Box>
                <ul>
                  ...
                  <li>
                    Generate business-friendly descriptions for tables and all
                    columns
                  </li>
                  <li>Save markdown metadata documents to Amazon S3</li>
                  <li>
                    Sync to the Amazon Bedrock Knowledge Base for natural
                    language query support
                  </li>
                </ul>
                <Alert type="info">
                  This process typically takes several minutes depending on the
                  number of tables and complexity of your schema. You'll see
                  real-time progress as each table is processed and enriched.
                </Alert>
                <Box>
            ...
            <Box>
              <SpaceBetween size="m">
                ...
                <Box variant="small" color="text-status-inactive">
                  Please wait while semantic metadata is being generated. The
                  agent is sampling data, generating descriptions, and updating
          ...
          {buildStatus === "completed" && (
            <Box>
              <SpaceBetween size="m">
                <Alert
                  type="success"
                  header="Semantic Metadata Built Successfully!"
                >
                  Successfully processed {totalTables} table
                  {totalTables !== 1 ? "s" : ""}. You can now query your data
                ...
                <Box>
                  <SpaceBetween direction="horizontal" size="xs">
                    <Button
                      variant="primary"
                      onClick={() =>
                        navigate(`/admin/view-semantic-metadata/${id}`)
                      }
                    >
                      View Results
                    </Button>
